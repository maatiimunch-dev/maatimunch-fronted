...
export const CartProvider = ({ children }) => {
  ...
  const fetchCart = async () => {
    try {
      ...
      // ✅ FIXED: /products/${userId} → /products/cart/${userId}
  ...
  const addToCart = async (product, quantity = 1) => {
    try {
      ...
      // ✅ FIXED: /products/add-to-cart → /products/cart/add
  ...
  const removeFromCart = async (productId) => {
    try {
      ...
      // ✅ FIXED: /products/remove → /products/cart/remove
  ...
  const updateQuantity = async (productId, quantity) => {
    ...
    try {
      ...
      // ✅ FIXED: /products/update → /products/cart/update
      await api.put('/products/cart/update', { userId, productId, quantity });
  ...
  const clearCart = async () => {
    try {
      ...
      // ✅ FIXED: /products/clear → /products/cart/clear
